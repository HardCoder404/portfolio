...
const recommendationCard = [
  {
    ...
    view: "Hey everyone! I wanted to take a moment to recommend Prince Raj for any React.js or Next.js opportunities. I had the pleasure of working with him on multiple projects where he showcased a strong understanding of React.js and Next.js concepts and delivered high-quality code. He consistently demonstrated a willingness to learn and grow, and his enthusiasm for tackling new challenges was contagious. Prince is a reliable and dedicated team member who would be a great asset to any React.js / Next.js team. Highly recommended! 👍! 🌟",
  ...
  },
  {
    ...
    view: "I wholeheartedly recommend Prince as a talented React frontend developer with an incredible flair for responsiveness. His proficiency in Node.js further enhances his capabilities, allowing him to build robust and scalable applications. Prince's attention to detail, problem-solving skills, and dedication to delivering exceptional results make him a valuable addition to any development team.",
  ...
  },
  {
    ...
    view: "I highly recommend Prince Raj for web frontend development positions. Their expertise in ReactJS and Next.js, combined with their professionalism and dedication, make them an invaluable asset to any team. Top-notch! Highly suggested! 🌟💪",
